"""Private/local ScoreMax V6.5.6 internal-live launcher."""
from __future__ import annotations
import os, secrets
from pathlib import Path
BASE=Path(__file__).resolve().parent
DATA=BASE/'internal_live_data'; DATA.mkdir(exist_ok=True)
secret_file=DATA/'session_secret_v656.txt'
...
os.environ.setdefault('SCOREMAX_DB',str(DATA/'scoremax_v6_5_6_internal_live.db'))
...
if __name__=='__main__':
    app.init()
    print('\nScoreMax V6.5.6 POWER HOUSE MANIFEST EXPLICIT-PORT NORMALISATION RECTIFICATION — INTERNAL LIVE')
