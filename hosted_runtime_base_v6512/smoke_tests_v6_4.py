...
ok('health keeps immutable parent compatibility marker and exposes V6.4.0 release identity',health['version']=='6.2.8.1' and is_compatible_descendant(health['release_version'],'6.4.0') and bool(health['build_name']))
