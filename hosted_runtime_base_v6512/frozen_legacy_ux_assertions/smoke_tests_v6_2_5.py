...
def main():
    ...
    ok('Dashboard uses one compact Daily Spark module with two streams',dashboard.count('class="daily-spark card"')==1 and 'Academic Spark' in dashboard and 'Word of the Day' in dashboard)
    ok('Daily Spark explicitly protects the formal-mastery boundary','never used as proof of formal mastery' in dashboard)
    ok('Sustainability stays under More and public navigation rather than core learning',base.index('Progress')<base.index('Sustainability') and 'admin_sustainability' in base and 'admin_daily_spark' in base)
