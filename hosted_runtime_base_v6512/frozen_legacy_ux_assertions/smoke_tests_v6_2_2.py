...
def main() -> None:
    ...
    ok("student desktop navigation uses eight clear student journeys", all(label in desktop for label in ["Dashboard", "Learn", "My Plan", "Tests", "Exams", "Progress", "Knowledge", "More"]))
