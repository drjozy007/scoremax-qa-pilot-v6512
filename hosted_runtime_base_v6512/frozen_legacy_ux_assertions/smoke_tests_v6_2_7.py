...
def main():
    ...
    ok('student navigation remains accessible after the two-row uplift',(('nav-toggle' in base and 'aria-haspopup="true"' in base and "ArrowDown" in base) or ('student-secondary-nav' in base and 'mobile-bottom-nav' in base)))
