"""Private/local ScoreMax V6.5.3 integration admission-rectification internal-live launcher."""
from __future__ import annotations
import os, secrets
from pathlib import Path
BASE=Path(__file__).resolve().parent
DATA=BASE/'internal_live_data'; DATA.mkdir(exist_ok=True)
secret_file=DATA/'session_secret_v653.txt'
...
os.environ.setdefault('SCOREMAX_DB',str(DATA/'scoremax_v6_5_3_internal_live.db'))
...
if __name__=='__main__':
    app.init()
    print('\nScoreMax V6.5.3 THREE-SYSTEM INTEGRATION ADMISSION RECTIFICATION — INTERNAL LIVE')
