"""Private/local ScoreMax V6.5.4 integration admission-rectification internal-live launcher."""
from __future__ import annotations
import os, secrets
from pathlib import Path
BASE=Path(__file__).resolve().parent
DATA=BASE/'internal_live_data'; DATA.mkdir(exist_ok=True)
secret_file=DATA/'session_secret_v654.txt'
...
os.environ.setdefault('SCOREMAX_DB',str(DATA/'scoremax_v6_5_4_internal_live.db'))
...
if __name__=='__main__':
    app.init()
    print('\nScoreMax V6.5.4 THREE-SYSTEM INTEGRATION ADMISSION RECTIFICATION — INTERNAL LIVE')
