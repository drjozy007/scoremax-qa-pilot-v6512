"""Private/local ScoreMax V6.5.1 integration rectification internal-live launcher."""
from __future__ import annotations
import os, secrets
from pathlib import Path
BASE=Path(__file__).resolve().parent
DATA=BASE/'internal_live_data'; DATA.mkdir(exist_ok=True)
secret_file=DATA/'session_secret_v651.txt'
...
os.environ.setdefault('SCOREMAX_DB',str(DATA/'scoremax_v6_5_1_internal_live.db'))
...
if __name__=='__main__':
    app.init()
    print('\nScoreMax V6.5.1 THREE-SYSTEM INTEGRATION RECTIFICATION — INTERNAL LIVE')
    ...
    print('Growth Engine: asynchronous product/referral event outbox enabled')
