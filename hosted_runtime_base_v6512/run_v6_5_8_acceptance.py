"""ScoreMax V6.5.8 deterministic platform-side acceptance runner.

Narrow child of exact frozen V6.5.6. Closes only INT-PHSM-B01-LRN-P1-001 and INT-PHSM-B01-LRN-P1-002.
...
def main():
    tmp=Path(tempfile.mkdtemp(prefix='scoremax_v658_compile_'))
    ...
    print(f'V6.5.8 PYTHON COMPILE PASS: {len(pyfiles)} files')
    print(f'V6.5.8 JINJA PARSE PASS: {len(templates)} templates')
    ...
    print('\nSCOREMAX V6.5.8 LOCAL ACCEPTANCE PASS')
    print('Exact parent: V6.5.7 SHA-256 a93edef7a4ea6cc4b8d5d8e27ef2eecdba29d0be441f974ecec5bebfcef9c118')
    print('Rectified finding: INT-PHSM-B01-LRN-P1-001 and INT-PHSM-B01-LRN-P1-002 only')
    ...
    print('V6.5.8 product-activation assertions: 25/25 PASS')
    ...
    print('CONNECTED BATCH01: pending independent central requalification with the same frozen 300; do not start the real 1,500 batch until P0=0 and P1=0.')
    print('WINDOWS: separate infrastructure/CI gate; not a V6.5.8 product-rectification prerequisite.')
