...
ok('health keeps immutable parent compatibility marker and exposes V6.4.0 release identity',health['version']=='6.2.8.1' and health['release_version']=='6.4.0' and health['build_name']=='Live Pilot UX & Operations')
