...
ok('compatibility health keeps parent marker and exposes current V6.3 descendant marker', health['version']=='6.2.8.1' and health['release_version'] in {'6.3.2','6.4.0','6.5.0'})
