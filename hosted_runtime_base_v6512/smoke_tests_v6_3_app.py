...
ok('compatibility health keeps parent marker and exposes current V6.3 descendant marker', health['version']=='6.2.8.1' and is_compatible_descendant(health['release_version'],'6.3.2'))
