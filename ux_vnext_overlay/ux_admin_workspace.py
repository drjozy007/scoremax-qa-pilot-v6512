...
def _simplify_admin_navigation(path: Path) -> None:
  ...
  {% elif session.get('user_id') %}'''
    ...
    for token in ("url_for('admin_dashboard')","url_for('admin_view_as')","url_for('admin_questions')","url_for('admin_users')","url_for('admin_interests')","url_for('admin_mastery_rigor')","url_for('admin_integration_health')",'>Logout</a>','admin-preview-bar',"url_for('admin_view_as_exit')"):
