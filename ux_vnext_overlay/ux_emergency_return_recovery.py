...
def apply_emergency_return_recovery(root:Path)->None:
    ...
    print(f'{MARKER} PASS startup_reconciliation=true prebridge_only=true duplicate_admin_incident_blocked=true persistent_guard_v4_reused=true second_exception_system=false',flush=True)
