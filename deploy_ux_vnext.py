...
def main() -> None:
    ...
    # Staging-only editor: load it after the public page is rendered.
    ...
    print("SCOREMAX_UX_VNEXT_STAGING_MATERIALIZED base_release=6.6.11C presentation_only=true text_editor=true public_nav=ordered")
